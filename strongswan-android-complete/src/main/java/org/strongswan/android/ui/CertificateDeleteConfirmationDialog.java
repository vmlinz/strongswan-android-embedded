...
public class CertificateDeleteConfirmationDialog extends DialogFragment
{
	...
	public Dialog onCreateDialog(Bundle savedInstanceState)
	{
		return new AlertDialog.Builder(getActivity())
			...
			.setTitle(R.string.strongswan_delete_certificate_question)
			.setMessage(R.string.strongswan_delete_certificate)
			.setPositiveButton(R.string.strongswan_delete_profile, new DialogInterface.OnClickListener() {
				@Override
