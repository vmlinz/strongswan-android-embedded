...
public class MainActivity extends Activity implements OnVpnProfileSelectedListener
{
	...
	public void onCreate(Bundle savedInstanceState)
	{
		...
		setContentView(R.layout.strongswan_main);
	...
	{
		getMenuInflater().inflate(R.menu.strongswan_main, menu);
		return true;
	}
	...
	protected void prepareVpnService(Bundle profileInfo)
	{
		...
		catch (IllegalStateException ex)
		{
			...
			VpnNotSupportedError.showWithMessage(this, R.string.strongswan_vpn_not_supported_during_lockdown);
			return;
		}
	...
	public static class ConfirmationDialog extends DialogFragment
	{
		...
		public Dialog onCreateDialog(Bundle savedInstanceState)
		{
			...
			int title = R.string.strongswan_connect_profile_question;
			int message = R.string.strongswan_replaces_active_connection;
			int button = R.string.strongswan_connect;

			if (profileInfo.getBoolean(PROFILE_RECONNECT))
			{
				icon = android.R.drawable.ic_dialog_info;
				title = R.string.strongswan_vpn_connected;
				message = R.string.strongswan_vpn_profile_connected;
				button = R.string.strongswan_reconnect;
			}
	...
	public static class LoginDialog extends DialogFragment
	{
		...
		public Dialog onCreateDialog(Bundle savedInstanceState)
		{
			...
			View view = inflater.inflate(R.layout.strongswan_login_dialog, null);
			EditText username = (EditText)view.findViewById(R.id.strongswan_username);
			username.setText(profileInfo.getString(VpnProfileDataSource.KEY_USERNAME));
			final EditText password = (EditText)view.findViewById(R.id.strongswan_password);

			Builder adb = new AlertDialog.Builder(getActivity());
			adb.setView(view);
			adb.setTitle(getString(R.string.strongswan_login_title));
			adb.setPositiveButton(R.string.strongswan_login_confirm, new DialogInterface.OnClickListener() {
				@Override
				public void onClick(DialogInterface dialog, int whichButton)
				{
					MainActivity activity = (MainActivity)getActivity();
	...
	public static class VpnNotSupportedError extends DialogFragment
	{
		...
		public Dialog onCreateDialog(Bundle savedInstanceState)
		{
			...
			return new AlertDialog.Builder(getActivity())
				.setTitle(R.string.strongswan_vpn_not_supported_title)
