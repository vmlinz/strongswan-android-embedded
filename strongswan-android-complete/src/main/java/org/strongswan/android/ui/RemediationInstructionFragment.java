...
public class RemediationInstructionFragment extends ListFragment
{
	...
	{
		return inflater.inflate(R.layout.strongswan_remediation_instruction, container, false);
	}
	...
	public void onActivityCreated(Bundle savedInstanceState)
	{
		...
		setListShown(true);
		mTitle = (TextView)getView().findViewById(R.id.strongswan_title);
		mDescription = (TextView)getView().findViewById(R.id.strongswan_description);
		mHeader = (TextView)getView().findViewById(R.id.strongswan_list_header);
	}
