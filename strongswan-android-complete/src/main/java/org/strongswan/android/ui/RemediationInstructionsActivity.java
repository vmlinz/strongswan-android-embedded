...
public class RemediationInstructionsActivity extends Activity implements OnRemediationInstructionSelectedListener
{
	...
	protected void onCreate(Bundle savedInstanceState)
	{
		...
		setContentView(R.layout.strongswan_remediation_instructions);
		...
		RemediationInstructionsFragment frag = (RemediationInstructionsFragment)getFragmentManager().findFragmentById(R.id.strongswan_remediation_instructions_fragment);
		if (frag != null)
		...
		{	/* one-pane layout, create fragment */
			...
			getFragmentManager().beginTransaction().add(R.id.strongswan_fragment_container, frag).commit();
		}
	}
	...
	{
		RemediationInstructionFragment frag = (RemediationInstructionFragment)getFragmentManager().findFragmentById(R.id.strongswan_remediation_instruction_fragment);
		...
		{	/* one-pane layout, replace fragment */
			...
			getFragmentManager().beginTransaction().replace(R.id.strongswan_fragment_container, frag).addToBackStack(null).commit();
