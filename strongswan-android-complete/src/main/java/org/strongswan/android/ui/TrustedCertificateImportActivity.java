...
public class TrustedCertificateImportActivity extends Activity
{
	...
	private void importCertificate(Uri uri)
	{
		...
		if (certificate == null)
		{
			Toast.makeText(this, R.string.strongswan_cert_import_failed, Toast.LENGTH_LONG).show();
			finish();
			return;
		}
	...
	public static class ConfirmImportDialog extends DialogFragment
	{
		...
		public Dialog onCreateDialog(Bundle savedInstanceState)
		{
			...
			return new AlertDialog.Builder(getActivity())
				.setIcon(R.drawable.strongswan_ic_launcher)
				.setTitle(R.string.strongswan_import_certificate)
				.setMessage(certificate.getSubjectDN().toString())
				.setPositiveButton(R.string.strongswan_import_certificate, new DialogInterface.OnClickListener() {
					@Override
					public void onClick(DialogInterface dialog, int whichButton)
					{
						...
						{
							Toast.makeText(getActivity(), R.string.strongswan_cert_imported_successfully, Toast.LENGTH_LONG).show();
							getActivity().setResult(Activity.RESULT_OK);
						}
						else
						{
							Toast.makeText(getActivity(), R.string.strongswan_cert_import_failed, Toast.LENGTH_LONG).show();
						}
						getActivity().finish();
					}
				})
