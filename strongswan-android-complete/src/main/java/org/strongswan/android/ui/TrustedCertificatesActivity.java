...
public class TrustedCertificatesActivity extends Activity implements TrustedCertificateListFragment.OnTrustedCertificateSelectedListener, OnCertificateDeleteListener
{
	...
	public void onCreate(Bundle savedInstanceState)
	{
		...
		setContentView(R.layout.strongswan_trusted_certificates_activity);
	...
	{
		getMenuInflater().inflate(R.menu.strongswan_certificates, menu);
		return true;
	}
	...
	public boolean onPrepareOptionsMenu(Menu menu)
	{
		...
		{
			menu.removeItem(R.id.strongswan_menu_import_certificate);
		}
		return true;
	}
	...
	public boolean onOptionsItemSelected(MenuItem item)
	{
		switch (item.getItemId())
		{
			case android.R.id.home:
				finish();
				return true;
			case R.id.strongswan_menu_reload_certs:
				reloadCertificates();
				return true;
			case R.id.strongswan_menu_import_certificate:
