...
public class VpnProfileSelectActivity extends Activity implements OnVpnProfileSelectedListener
{
	...
	protected void onCreate(Bundle savedInstanceState)
	{
		...
		setContentView(R.layout.strongswan_vpn_profile_select);
	...
	public void onVpnProfileSelected(VpnProfile profile)
	{
		...
		intent.putExtra(Intent.EXTRA_SHORTCUT_ICON_RESOURCE, Intent.ShortcutIconResource.fromContext(this, R.drawable.strongswan_ic_launcher));
