...
public class TrustedCertificateAdapter extends ArrayAdapter<TrustedCertificateEntry>
{
	...
	{
		super(context, R.layout.strongswan_trusted_certificates_item);
	}
	...
	public View getView(int position, View convertView, ViewGroup parent)
	{
		...
		else
		{
			...
			view = inflater.inflate(R.layout.strongswan_trusted_certificates_item, parent, false);
		}
		TrustedCertificateEntry item = getItem(position);
		TextView text = (TextView)view.findViewById(R.id.strongswan_subject_primary);
		text.setText(item.getSubjectPrimary());
		text = (TextView)view.findViewById(R.id.strongswan_subject_secondary);
