...
process Dir['src/main/res/**/colors.xml'] do |text|
  text.gsub(/name="(?<name>.*?)"/, "name=\"#{PREFIX}_\\k<name>\"")
end
...
process %w(build.gradle) do |text|
  ...
  text.gsub!(/^*applicationId "org\.strongswan\.android"$/, '')
